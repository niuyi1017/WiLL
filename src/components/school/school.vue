      ...
      <div class="desc-wrapper">
        <div class="desc">
          <div class="top">
            <div class="left">
              <div class="pic">
                <img src="https://static-data.eol.cn/upload/logo/554.jpg" alt="" srcset="">
              </div>
            </div>
            <div class="right">
